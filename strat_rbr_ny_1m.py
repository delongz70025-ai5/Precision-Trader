"""
MNQ NY Rally-Base-Rally (1min) — 2 Contracts: TP1 + Runner
═════════════════════════════════════════════════════════════
  ...
  - Fixed risk stop-loss at 65 pts
"""
...
def run_backtest(df: pd.DataFrame, params: dict) -> dict:
    ...
    fixed_risk_points = float(params.get("fixed_risk_points", 90.0))
    first_rr_ratio    = float(params.get("first_rr_ratio", 2.0))
