"""
MYM Combined ALL 6 Strategies (1-min) with Direction Lock
==========================================================
...
def run_backtest(df: pd.DataFrame, params: dict) -> dict:
    ...
    # -- ORB NY --
    orb_ny_tp1        = float(params.get("orb_ny_first_tp_points", 43.0))
    orb_ny_tp2        = float(params.get("orb_ny_second_tp_points", 45.0))
    orb_ny_trail      = float(params.get("orb_ny_trail_distance_points", 55.0))
    orb_ny_be         = float(params.get("orb_ny_runner_be_trigger_points", 45.0))
    orb_ny_cts        = int(params.get("orb_ny_contracts_per_trade", 6))
    orb_ny_c1         = int(params.get("orb_ny_tp1_contracts", 2))
    orb_ny_c2         = int(params.get("orb_ny_tp2_contracts", 2))
    orb_ny_max_stop   = float(params.get("orb_ny_max_stop_points", 180.0))
    orb_ny_min_rw     = float(params.get("orb_ny_min_range_width", 115.0))
    orb_ny_max_rw     = float(params.get("orb_ny_max_range_width", 205.0))
    ...
    # -- ORB Tokyo --
    orb_tk_tp1        = float(params.get("orb_tk_first_tp_points", 45.0))
    orb_tk_tp2        = float(params.get("orb_tk_second_tp_points", 50.0))
    orb_tk_trail      = float(params.get("orb_tk_trail_distance_points", 45.0))
    orb_tk_be         = float(params.get("orb_tk_runner_be_trigger_points", 50.0))
    ...
    orb_tk_min_rw     = float(params.get("orb_tk_min_range_width", 41.0))
    orb_tk_max_rw     = float(params.get("orb_tk_max_range_width", 120.0))
    orb_tk_flat_hr    = int(params.get("orb_tk_flatten_hour", 15))

    # -- ORB London --
    orb_ld_tp1        = float(params.get("orb_ld_first_tp_points", 25.0))
    orb_ld_tp2        = float(params.get("orb_ld_second_tp_points", 30.0))
    orb_ld_trail      = float(params.get("orb_ld_trail_distance_points", 20.0))
    orb_ld_be         = float(params.get("orb_ld_runner_be_trigger_points", 30.0))
    orb_ld_cts        = int(params.get("orb_ld_contracts_per_trade", 6))
    orb_ld_c1         = int(params.get("orb_ld_tp1_contracts", 2))
    orb_ld_c2         = int(params.get("orb_ld_tp2_contracts", 2))
    orb_ld_max_stop   = float(params.get("orb_ld_max_stop_points", 77.0))
    orb_ld_min_rw     = float(params.get("orb_ld_min_range_width", 60.0))
    orb_ld_max_rw     = float(params.get("orb_ld_max_range_width", 115.0))
    ...
    rbr_ny_vol_lb     = int(params.get("rbr_ny_vol_lookback", 45))
    rbr_ny_vol_mult   = float(params.get("rbr_ny_vol_multiplier", 1.7))
    ...
    rbr_ny_risk       = float(params.get("rbr_ny_fixed_risk_points", 35.0))
    rbr_ny_rr1        = float(params.get("rbr_ny_first_rr_ratio", 1.4))
    rbr_ny_rr_run     = float(params.get("rbr_ny_runner_rr_ratio", 3.4))
    rbr_ny_cts        = int(params.get("rbr_ny_contracts_per_trade", 8))
    rbr_ny_tp1_cts    = int(params.get("rbr_ny_tp1_contracts", 4))
    rbr_ny_flat_hr    = int(params.get("rbr_ny_flatten_hour", 16))

    # -- RBR Tokyo --
    rbr_tk_fast       = int(params.get("rbr_tk_fast_len", 5))
    rbr_tk_slow       = int(params.get("rbr_tk_slow_len", 20))
    rbr_tk_vol_lb     = int(params.get("rbr_tk_vol_lookback", 20))
    rbr_tk_vol_mult   = float(params.get("rbr_tk_vol_multiplier", 2.3))
    ...
    rbr_tk_risk       = float(params.get("rbr_tk_fixed_risk_points", 14.0))
    rbr_tk_rr1        = float(params.get("rbr_tk_first_rr_ratio", 1.2))
    rbr_tk_rr_run     = float(params.get("rbr_tk_runner_rr_ratio", 3.1))
    rbr_tk_cts        = int(params.get("rbr_tk_contracts_per_trade", 6))
    rbr_tk_tp1_cts    = int(params.get("rbr_tk_tp1_contracts", 2))
    rbr_tk_tp2_cts    = int(params.get("rbr_tk_tp2_contracts", 2))
    rbr_tk_tp2_rr     = float(params.get("rbr_tk_tp2_rr_ratio", (1.2 + 3.1) / 2))
    rbr_tk_flat_hr    = int(params.get("rbr_tk_flatten_hour", 15))

    # -- RBR London --
    rbr_ld_fast       = int(params.get("rbr_ld_fast_len", 7))
    rbr_ld_slow       = int(params.get("rbr_ld_slow_len", 21))
    rbr_ld_vol_lb     = int(params.get("rbr_ld_vol_lookback", 5))
    rbr_ld_vol_mult   = float(params.get("rbr_ld_vol_multiplier", 2.1))
    ...
    rbr_ld_risk       = float(params.get("rbr_ld_fixed_risk_points", 10.0))
    rbr_ld_rr1        = float(params.get("rbr_ld_first_rr_ratio", 1.5))
    rbr_ld_rr_run     = float(params.get("rbr_ld_runner_rr_ratio", 3.5))
    rbr_ld_cts        = int(params.get("rbr_ld_contracts_per_trade", 6))
    rbr_ld_tp1_cts    = int(params.get("rbr_ld_tp1_contracts", 2))
    rbr_ld_tp2_cts    = int(params.get("rbr_ld_tp2_contracts", 2))
    rbr_ld_tp2_rr     = float(params.get("rbr_ld_tp2_rr_ratio", (1.5 + 3.5) / 2))
    ...
    rbr_tk_stop = 0.0; rbr_tk_tp1_px = 0.0; rbr_tk_tp2_px = 0.0; rbr_tk_runner_px = 0.0
    rbr_tk_tp1_filled = False; rbr_tk_tp2_filled = False; rbr_tk_entry_time = None

    # -- RBR London state --
    rbr_ld_pos = 0; rbr_ld_entry_px = 0.0; rbr_ld_dir = 0
    rbr_ld_stop = 0.0; rbr_ld_tp1_px = 0.0; rbr_ld_tp2_px = 0.0; rbr_ld_runner_px = 0.0
    rbr_ld_tp1_filled = False; rbr_ld_tp2_filled = False; rbr_ld_entry_time = None
    ...
    for i in range(n):
        ...
        if orb_ny_pos > 0 and orb_ny_dir == 1 and not orb_ny_flat:
            ...
            if not orb_ny_tp1_filled and h >= orb_ny_entry_px + orb_ny_tp1:
                ...
                pnl = orb_ny_tp1 * orb_ny_c1 * pt_val - orb_ny_c1 * fee
                equity += pnl; orb_ny_pos -= orb_ny_c1
                trades.append(_trade(orb_ny_entry_time, _idx[i], orb_ny_entry_px, orb_ny_entry_px + orb_ny_tp1, 1, orb_ny_c1, pnl, "TP1", "ORB NY"))
            if orb_ny_pos > 0 and not orb_ny_tp2_filled and h >= orb_ny_entry_px + orb_ny_tp2:
                orb_ny_tp2_filled = True
                pnl = orb_ny_tp2 * orb_ny_c2 * pt_val - orb_ny_c2 * fee
                equity += pnl; orb_ny_pos -= orb_ny_c2
                trades.append(_trade(orb_ny_entry_time, _idx[i], orb_ny_entry_px, orb_ny_entry_px + orb_ny_tp2, 1, orb_ny_c2, pnl, "TP2", "ORB NY"))
        ...
        if orb_ld_pos > 0 and orb_ld_dir == 1 and not orb_ld_flat:
            ...
            if not orb_ld_tp1_filled and h >= orb_ld_entry_px + orb_ld_tp1:
                ...
                pnl = orb_ld_tp1 * orb_ld_c1 * pt_val - orb_ld_c1 * fee
                equity += pnl; orb_ld_pos -= orb_ld_c1
                trades.append(_trade(orb_ld_entry_time, _idx[i], orb_ld_entry_px, orb_ld_entry_px + orb_ld_tp1, 1, orb_ld_c1, pnl, "TP1", "ORB London"))
            if orb_ld_pos > 0 and not orb_ld_tp2_filled and h >= orb_ld_entry_px + orb_ld_tp2:
                orb_ld_tp2_filled = True
                pnl = orb_ld_tp2 * orb_ld_c2 * pt_val - orb_ld_c2 * fee
                equity += pnl; orb_ld_pos -= orb_ld_c2
                trades.append(_trade(orb_ld_entry_time, _idx[i], orb_ld_entry_px, orb_ld_entry_px + orb_ld_tp2, 1, orb_ld_c2, pnl, "TP2", "ORB London"))
        ...
        # =================================================================
        #  RBR NY — exit logic (TP1 + Runner, 4+4 split)
        # =================================================================
        if rbr_ny_pos > 0 and rbr_ny_dir == 1:
            if l <= rbr_ny_stop:
                ...
                if not rbr_ny_tp1_filled and h >= rbr_ny_tp1_px:
                    ...
                    pnl = (rbr_ny_tp1_px - rbr_ny_entry_px) * rbr_ny_tp1_cts * pt_val - rbr_ny_tp1_cts * fee
                    equity += pnl; rbr_ny_pos -= rbr_ny_tp1_cts
                    trades.append(_trade(rbr_ny_entry_time, _idx[i], rbr_ny_entry_px, rbr_ny_tp1_px, 1, rbr_ny_tp1_cts, pnl, "TP1", "RBR NY"))
            ...
            if h >= rbr_ny_stop:
                ...
                if not rbr_ny_tp1_filled and l <= rbr_ny_tp1_px:
                    rbr_ny_tp1_filled = True
                    pnl = (rbr_ny_entry_px - rbr_ny_tp1_px) * rbr_ny_tp1_cts * pt_val - rbr_ny_tp1_cts * fee
                    equity += pnl; rbr_ny_pos += rbr_ny_tp1_cts
                    trades.append(_trade(rbr_ny_entry_time, _idx[i], rbr_ny_entry_px, rbr_ny_tp1_px, -1, rbr_ny_tp1_cts, pnl, "TP1", "RBR NY"))
        ...
        if rbr_tk_flat and rbr_tk_pos != 0:
            ...
            rbr_tk_pos = 0; rbr_tk_dir = 0; rbr_tk_tp1_filled = False; rbr_tk_tp2_filled = False

        # =================================================================
        #  RBR TOKYO — exit logic (TP1 + TP2 + Runner, 2+2+2 split)
        # =================================================================
        if rbr_tk_pos > 0 and rbr_tk_dir == 1:
            if l <= rbr_tk_stop:
                ...
                if not rbr_tk_tp1_filled and h >= rbr_tk_tp1_px:
                    ...
                    pnl = (rbr_tk_tp1_px - rbr_tk_entry_px) * rbr_tk_tp1_cts * pt_val - rbr_tk_tp1_cts * fee
                    equity += pnl; rbr_tk_pos -= rbr_tk_tp1_cts
                    trades.append(_trade(rbr_tk_entry_time, _idx[i], rbr_tk_entry_px, rbr_tk_tp1_px, 1, rbr_tk_tp1_cts, pnl, "TP1", "RBR Tokyo"))
                if rbr_tk_pos > 0 and not rbr_tk_tp2_filled and h >= rbr_tk_tp2_px:
                    rbr_tk_tp2_filled = True
                    pnl = (rbr_tk_tp2_px - rbr_tk_entry_px) * rbr_tk_tp2_cts * pt_val - rbr_tk_tp2_cts * fee
                    equity += pnl; rbr_tk_pos -= rbr_tk_tp2_cts
                    trades.append(_trade(rbr_tk_entry_time, _idx[i], rbr_tk_entry_px, rbr_tk_tp2_px, 1, rbr_tk_tp2_cts, pnl, "TP2", "RBR Tokyo"))
            ...
            if h >= rbr_tk_stop:
                ...
                if not rbr_tk_tp1_filled and l <= rbr_tk_tp1_px:
                    rbr_tk_tp1_filled = True
                    pnl = (rbr_tk_entry_px - rbr_tk_tp1_px) * rbr_tk_tp1_cts * pt_val - rbr_tk_tp1_cts * fee
                    equity += pnl; rbr_tk_pos += rbr_tk_tp1_cts
                    trades.append(_trade(rbr_tk_entry_time, _idx[i], rbr_tk_entry_px, rbr_tk_tp1_px, -1, rbr_tk_tp1_cts, pnl, "TP1", "RBR Tokyo"))
                if rbr_tk_pos < 0 and not rbr_tk_tp2_filled and l <= rbr_tk_tp2_px:
                    rbr_tk_tp2_filled = True
                    pnl = (rbr_tk_entry_px - rbr_tk_tp2_px) * rbr_tk_tp2_cts * pt_val - rbr_tk_tp2_cts * fee
                    equity += pnl; rbr_tk_pos += rbr_tk_tp2_cts
                    trades.append(_trade(rbr_tk_entry_time, _idx[i], rbr_tk_entry_px, rbr_tk_tp2_px, -1, rbr_tk_tp2_cts, pnl, "TP2", "RBR Tokyo"))
        ...
        if rbr_ld_flat and rbr_ld_pos != 0:
            ...
            rbr_ld_pos = 0; rbr_ld_dir = 0; rbr_ld_tp1_filled = False; rbr_ld_tp2_filled = False

        # =================================================================
        #  RBR LONDON — exit logic (TP1 + TP2 + Runner, 2+2+2 split)
        # =================================================================
        if rbr_ld_pos > 0 and rbr_ld_dir == 1:
            if l <= rbr_ld_stop:
                ...
                if rbr_ld_pos > 0 and not rbr_ld_tp2_filled and h >= rbr_ld_tp2_px:
                    rbr_ld_tp2_filled = True
                    pnl = (rbr_ld_tp2_px - rbr_ld_entry_px) * rbr_ld_tp2_cts * pt_val - rbr_ld_tp2_cts * fee
                    equity += pnl; rbr_ld_pos -= rbr_ld_tp2_cts
                    trades.append(_trade(rbr_ld_entry_time, _idx[i], rbr_ld_entry_px, rbr_ld_tp2_px, 1, rbr_ld_tp2_cts, pnl, "TP2", "RBR London"))
            ...
            if h >= rbr_ld_stop:
                ...
                if not rbr_ld_tp1_filled and l <= rbr_ld_tp1_px:
                    ...
                    equity += pnl; rbr_ld_pos += rbr_ld_tp1_cts
                    trades.append(_trade(rbr_ld_entry_time, _idx[i], rbr_ld_entry_px, rbr_ld_tp1_px, -1, rbr_ld_tp1_cts, pnl, "TP1", "RBR London"))
                if rbr_ld_pos < 0 and not rbr_ld_tp2_filled and l <= rbr_ld_tp2_px:
                    rbr_ld_tp2_filled = True
                    pnl = (rbr_ld_entry_px - rbr_ld_tp2_px) * rbr_ld_tp2_cts * pt_val - rbr_ld_tp2_cts * fee
                    equity += pnl; rbr_ld_pos += rbr_ld_tp2_cts
                    trades.append(_trade(rbr_ld_entry_time, _idx[i], rbr_ld_entry_px, rbr_ld_tp2_px, -1, rbr_ld_tp2_cts, pnl, "TP2", "RBR London"))
        ...
        if rbr_tk_pos == 0 and rbr_tk_in_sess and not rbr_tk_flat and i >= rbr_tk_lookback:
            ...
            if not (np.isnan(ef) or np.isnan(es)):
                ...
                if long_sig and (locked_direction == 0 or locked_direction == 1):
                    ...
                    rbr_tk_tp1_filled = False; rbr_tk_tp2_filled = False; rbr_tk_entry_time = _idx[i]
                    rbr_tk_stop = c - rbr_tk_risk
                    rbr_tk_tp1_px = c + rbr_tk_risk * rbr_tk_rr1
                    rbr_tk_tp2_px = c + rbr_tk_risk * rbr_tk_tp2_rr
        ...
        if rbr_ld_pos == 0 and rbr_ld_in_sess and not rbr_ld_flat and i >= rbr_ld_lookback:
            ...
            if not (np.isnan(ef) or np.isnan(es)):
                ...
                if long_sig and (locked_direction == 0 or locked_direction == 1):
                    ...
                    rbr_ld_tp1_filled = False; rbr_ld_tp2_filled = False; rbr_ld_entry_time = _idx[i]
                    rbr_ld_stop = c - rbr_ld_risk
                    rbr_ld_tp1_px = c + rbr_ld_risk * rbr_ld_rr1
                    rbr_ld_tp2_px = c + rbr_ld_risk * rbr_ld_tp2_rr
