"""
MNQ Tokyo Rally-Base-Rally (1min) — 2 Contracts: TP1 + Runner
═════════════════════════════════════════════════════════════════
  ...
  - 2 contracts: TP1 (1.5x risk), Runner (3.75x risk)
  - Fixed risk stop-loss at 47 pts
"""
...
def run_backtest(df: pd.DataFrame, params: dict) -> dict:
    ...
    fixed_risk_points = float(params.get("fixed_risk_points", 40.0))
    first_rr_ratio    = float(params.get("first_rr_ratio", 2.5))
    runner_rr_ratio   = float(params.get("runner_rr_ratio", 2.5))
